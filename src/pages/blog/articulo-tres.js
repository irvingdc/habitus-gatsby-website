...
export default () => {
    ...
    return (
        <div>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Habitus | Blog - Articulo Tres</title>
                <link rel="canonical" href="https://habitus.com.mx/blog/articulo-tres/" />
            ...
            <div className={ classes.flex }>
                <div className={ classes.section }>
                    <div className={ classes.text }>
                        <img src={ BLOG_ARTICLES[2].img }/>
                        <h2>{ BLOG_ARTICLES[2].title }</h2>
                        <h5>{ BLOG_ARTICLES[2].date }</h5>
                        <p>
